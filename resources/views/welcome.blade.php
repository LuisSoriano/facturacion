                    ...
                    <ul class="text-light">
                        <li>
                            <p class="card-text mb-2">
                                <strong>Plaguicidas de Uso Doméstico:</strong> Tramitación ágil del Certificado de Despacho Aduanero para productos terminados PUD.
                            </p>
                        </li>
                        <li>
                            <p class="card-text mb-2">
                                <strong>Materias Primas:</strong> Gestión técnica de certificados para el ingreso de insumos destinados a la industria y producción.
                            </p>
                        </li>
                        <li>
                            <p class="card-text mb-2">
                                <strong>Muestras no Comerciales:</strong> Emisión de autorizaciones especiales para el ingreso de productos de exhibición o análisis.
                            </p>
                        </li>
                        <li>
                            <p class="card-text mb-2">
                                <strong>Acceso 24/7:</strong> Radica tus solicitudes de importación en cualquier momento, reduciendo tiempos de nacionalización.
                            </p>
                        </li>
                    </ul>
                </div>
            ...
            <div class="card border-0 bg-transparent">
                ...
                <div class="card-body">
                    <ul class="text-light">
                        <li>
                            <p class="card-text mb-2">
                                <strong>Certificado Libre Venta (CLV):</strong> Obtención del documento esencial para que tus productos compitan en mercados internacionales.
                            </p>
                        </li>
                        <li>
                            <p class="card-text mb-2">
                                <strong>Certificados de Exportación:</strong> Automatización de la documentación requerida para el despacho de mercancía al exterior.
                            </p>
                        </li>
                        <li>
                            <p class="card-text mb-2">
                                <strong>Apostillado PUD:</strong> Gestión y validación de certificados de productos de uso doméstico para validez legal internacional.
                            </p>
                        </li>
                        <li>
                            <p class="card-text mb-2">
                                <strong>Trazabilidad de Trámites:</strong> Control total sobre el estado de tus apostillas y visados desde una única plataforma web.
                            </p>
                        </li>
                    </ul>
                </div>
