...
<div class="container-fluid px-4">
    ...
    <div class="mb-4">
        <a href="{{route('servicios.create')}}">
            <button type="button" class="btn btn-primary"><i class='fas fa-plus-circle'></i> Crear Servicio</button>
        </a>
    </div>
    @endcan
                            ...
                            <div class="d-flex justify-content-around">
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        <!-----Editar Servicio--->
                                        @can('editar-servicio')
                                        <li><a class="dropdown-item" href="{{route('servicios.edit',['servicio' => $item])}}">
                                                Editar</a>
                                        </li>
                                        @endcan
                                        <!----Ver-servicio--->
