    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                @can('ver-kardexServicio')
                <x-nav.nav-link content='Kardex Servicios'
                    icon='fa-solid fa-file'
                    :href="route('kardexServicio.index')" />
                @endcan
                ...
                @endcan
                {{-- @can('ver-ventaServicio')
                <x-nav.link-collapsed
                    id="collapseVentas"
                    icon="fa-solid fa-cart-shopping"
                    content="Venta de Servicios">
                    @can('ver-ventaServicio')
                    <x-nav.link-collapsed-item :href="route('ventaServicios.index')" content="Ver" />
                    @endcan

                    @can('crear-ventaServicio')
                    <x-nav.link-collapsed-item :href="route('ventaServicios.create')" content="Crear" />
                    @endcan
                </x-nav.link-collapsed>
                @endcan --}}
